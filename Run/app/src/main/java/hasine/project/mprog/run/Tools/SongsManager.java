...
public class SongsManager {
    ...
    List<Item> songList = new ArrayList<Item>();
    Random mRandom = new Random();

    // Constructor
    public SongsManager(ContentResolver cr) {
        mContentResolver = cr;
    }
    ...
    public List<Item> getPlayList() {
        ...
        // add each song to songList
        do {
            Log.i(TAG, "ID: " + cur.getString(idColumn) + " Title: " + cur.getString(titleColumn));
            songList.add(new Item(
    ...
    public Item getRandomItem() {
        ...
        return songList.get(mRandom.nextInt(songList.size()));
    }
